...
On top of that, you have two neat functionalities: if you *Shift + Click* on a a robot in the arena view in ARGoS, two debbug panels will appear in the Lua editor, with a list of the robot's functions, variables, and their values. Last, if you *Ctrl + Click* on a robot, drag it and release elsewhere, the robot will teleporte to this new location.
